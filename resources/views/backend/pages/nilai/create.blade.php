...
@section('content')
    ...
    <div class="main-content-inner">
                                ...
                                <select name="mapel" class="form-control" id="" required
                                    ...
                                    @foreach ($mapel as $item)
                                        <option value="{{ $item->id }}"
                                            {{ Request::get('mapel') == $item->id ? 'selected' : '' }}>
                                            {{ $item->nama_mapel }} |
                                            Kelas
        ...
        @if (Request::get('mapel') != null)
            @if (!empty($siswa))
                <div class="row">
                    <form action="{{ route('nilai.siswa.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="col-12 mt-2">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <input type="hidden" name="id_mapel" value="{{ Request::get('mapel') }}">
